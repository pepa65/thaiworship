...
cat <<-\EOP |tee -a "$html_file" >>"$html2_file"
	...
	<a href="https://gitlab.com/pepa65/thaiworship/blob/master/worship.html" title="Download browser-based Thai worship projection for offline usage">ดาวน์โหลดเพลงนมัสการสำหรับเครื่องฉายใช้งานออฟไลน์ได้</a><br /><br />
