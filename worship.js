//<![CDATA[<!--
// Copyright 2021 © OMF International (GPL-3+ licence)
...
var w3 = {
	...
	key_down: function (event){
		...
		// Select background image: CapsLock I
			...
			document.getElementById("bg").src = prompt(w3.localize("background"), "https://wallpaperaccess.com/download/sky-hd-58330");
			return w3.cancel(event);}
	...
	strings: {
		"th": {
			...
			"help": "ความช่วยเหลือ",
			"index": "สารบัญบทเพลง",
			"org": "โอเอ็มเอฟ อินเทอร์เนชันนัล",
